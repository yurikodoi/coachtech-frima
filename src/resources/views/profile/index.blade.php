...
<div class="mypage">
    <div class="mypage__header">
        <div class="mypage__user-info">
            <div class="mypage__image">
                <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('img/default-user.png') }}" alt="ユーザーアイコン">
            </div>
    ...
    <div class="mypage__tabs">
        <input type="radio" name="tab_item" id="tab_selling" checked>
        <label class="mypage__tab-label" for="tab_selling">出品した商品</label>
        <input type="radio" name="tab_item" id="tab_bought">
